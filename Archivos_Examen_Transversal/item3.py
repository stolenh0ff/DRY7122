...
@app.route('/')
def index():
    return 'Uso con curl: curl --insecure -X POST -d "username=nombre_de_usuario&password=contraseña" https://localhost:9500/signup/v2 o https://localhost:9500/login/v2'
...
def signup_v2():
    ...
    try:
        ...
        return f"Username {request.form['username']} has been registered. \n"
    return f"User {request.form['username']} signed up ! \n"
